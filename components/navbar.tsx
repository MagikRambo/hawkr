...
import { useUser, Session, SupabaseClient, useSession, useSupabaseClient, User } from '@supabase/auth-helpers-react'
...
type SignInMenuState = {
}

class SignInMenu extends React.Component<SignInMenuProps, SignInMenuState>{

    constructor(props: SignInMenuProps) {
        super(props)
    }
        ...
        return (
            <>
                {this.props.session ? (
                    <Link
                        href="/SignIn"
                        className={"border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center border-b-4 px-1 pt-1 text-sm font-medium"}
                    >
                        Sign In
                    </Link>) : (
                    ...
                    <>
                        ...
                        <Disclosure.Panel className="lg:hidden">
                            <div className="space-y-1 pt-2 pb-3">
                                {/* Current: "bg-cyan-50 border-indigo-500 text-indigo-700", Default: "border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800" */}
                                <Disclosure.Button
                                    as="a"
                                    href="#"
                                    className="block border-l-4 border-cyan-400 bg-indigo-50 py-2 pl-3 pr-4 text-base font-medium text-indigo-700"
                                >
                                    Dashboard
                                </Disclosure.Button>
                                <Disclosure.Button
