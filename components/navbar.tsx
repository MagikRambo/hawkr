                        ...
                        <div className="flex h-16 justify-between">
                            <div className="flex px-2 lg:px-0">
                                ...
                                <div className="hidden lg:ml-6 lg:flex lg:space-x-8">
                                    ...
                                    <Link
                                        href="/explore" onClick={()=>curr_idx=1}
                                        className={classNames( curr_idx == 1? "border-cyan-400 text-gray-900" : "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700",
                                            "inline-flex items-center border-b-4 px-1 pt-1 text-sm font-medium")}
                                    >
                                        Explore Nearby
                                    </Link>
                                    <Link
                                        href="/types" onClick={()=>curr_idx=2}
                                        className={classNames( curr_idx == 2? "border-cyan-400 text-gray-900" : "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700",
                                            "inline-flex items-center border-b-4 px-1 pt-1 text-sm font-medium")}
                                    >
                                        Hawkr Type
                                    </Link>
