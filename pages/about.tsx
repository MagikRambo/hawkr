              ...
              <li key={person.name}>
                ...
                {person.name === 'Mike Marambio' && (
                 ...
                 {person.name === 'Alex Romero' && (
                    <>
                    <p className="pb-4">My name is Alex, I am a Hispanic American studying at the University of Utah. This year I am graduating with a bachelor’s degree in computer science and am currently in search of software engineering positions.</p>
